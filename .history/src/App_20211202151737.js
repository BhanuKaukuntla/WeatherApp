      ...
      <section class="relative bg-white-900  min-h-screen">
        ...
        <div class="relative container pt-12 px-4 mb-20 mx-auto text-center">
          ...
          <input
            ...
            onChange={e => setCity(e.target.value)}
            placeholder="Search City"
            class="relative z-10 inline-block w-full md:w-auto mb-2  px-3 py-2 mr-2  font-medium leading-normal bg-transparent border-2 rounded-lg text-black-400 "
          ></input>
          <button
            onClick={() => dispatch(fetchWeatherAction(city))}
            type="button"
          ...
          <div class="max-w-6xl px-4 mx-auto ">
            <div class="flex flex-wrap -mx-4 justify-center">
              <div class="w-full md:w-1/3 px-4">
                <div class="p-8 border border-black-800 rounded-lg">
